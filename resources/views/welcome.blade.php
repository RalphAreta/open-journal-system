            ...
            *, *::before, *::after { box-sizing: border-box; }
            ...
            .shimmer-bar {
                ...
                background: linear-gradient(90deg,
                    transparent 0%, var(--gold-lt) 20%, var(--gold) 40%,
                    #f0d678 50%, var(--gold) 60%, var(--gold-lt) 80%, transparent 100%);
            ...
            @media (min-width: 768px) {
                .nav-logo-icon { width: 42px; height: 42px; border-radius: 10px; }
            }
            .nav-logo:hover .nav-logo-icon { transform: rotate(8deg); }
            .nav-logo-text { line-height: 1; min-width: 0; }
            .nav-logo-name {
            ...
            @media (min-width: 768px) { .nav-logo-name { font-size: 1.15rem; } }
            .nav-logo-sub {
                font-size: 0.55rem;
                font-weight: 700;
            ...
            .nav-hamburger:hover { background: rgba(45,129,118,0.08); }
            ...
            .mobile-nav-link:hover { color: var(--teal); background: var(--teal-lt); }
            .mobile-nav-register {
                display: block;
                margin-top: 8px;
                padding: 13px 14px;
            ...
            .hero-bg-glow {
                ...
                background: radial-gradient(ellipse at center,
                    rgba(201,168,76,0.12) 0%, rgba(45,129,118,0.06) 40%, transparent 70%);
            }
            .hero-bg-accent {
            ...
            @media (min-width: 768px) { .hero-circle-1 { width: 320px; height: 320px; } }
            .hero-circle-2 {
            ...
            @media (min-width: 768px) { .hero-circle-2 { width: 480px; height: 480px; } }
            .hero-circle-3 {
            ...
            @media (min-width: 768px) { .hero-circle-3 { width: 400px; height: 400px; } }
            ...
            @media (min-width: 640px) { .hero-inner { padding: 80px 28px 70px; } }
            @media (min-width: 900px) { .hero-inner { padding: 100px 32px; } }
            ...
            @media (min-width: 480px) { .hero-eyebrow { font-size: 0.7rem; margin-bottom: 22px; } }
            .hero-eyebrow::before {
                content: '';
            ...
            @media (min-width: 480px) { .hero-h1 { margin-bottom: 22px; } }
            ...
            @media (min-width: 480px) { .hero-p { font-size: 1.05rem; margin-bottom: 38px; } }
            ...
            .btn-hero-primary {
                ...
                transition: background 0.2s, transform 0.2s, box-shadow 0.28s;
                position: relative; overflow: hidden;
                border: 2px solid var(--gold);
            }
            @media (min-width: 480px) { .btn-hero-primary { padding: 16px 36px; font-size: 0.82rem; } }
            ...
            .btn-hero-primary:hover {
                background: #d9b85c; transform: translateY(-4px);
            ...
            @media (min-width: 480px) { .btn-hero-secondary { padding: 16px 36px; font-size: 0.82rem; } }
            ...
            @media (min-width: 640px) { .index-bar { padding: 14px 32px; } }
            .index-bar-inner {
                max-width: 1280px; margin: 0 auto;
            ...
            @media (min-width: 480px) { .index-bar-label { font-size: 0.62rem; } }
            .index-bar-divider { width: 1px; height: 18px; background: var(--border-dk); flex-shrink: 0; }
            ...
            .index-chip-dot { width: 6px; height: 6px; border-radius: 50%; background: var(--teal); flex-shrink: 0; }

            /* ── Section base ── */
            .section { padding: 60px 20px; }
            @media (min-width: 640px) { .section { padding: 80px 28px; } }
            @media (min-width: 1024px) { .section { padding: 96px 32px; } }

            .section-inner { max-width: 1280px; margin: 0 auto; }
            .section-header { text-align: center; margin-bottom: 40px; }
            @media (min-width: 640px) { .section-header { margin-bottom: 60px; } }
            ...
            .section-sub { font-size: 0.9rem; color: var(--ink-soft); margin-top: 10px; }
            @media (min-width: 640px) { .section-sub { font-size: 0.95rem; } }

            /* ── Metrics ── */
            .metrics-section {
                background: linear-gradient(135deg, var(--teal-dk) 0%, #1f5c54 100%);
                padding: 56px 20px;
            }
            @media (min-width: 640px) { .metrics-section { padding: 80px 32px; } }
            ...
            .metrics-grid {
                ...
                padding: 2px; border-radius: 16px; overflow: hidden;
            }
            ...
            @media (min-width: 640px) { .metric-cell { padding: 40px 28px; } }
            .metric-cell:hover { background: rgba(26,77,70,0.9); border-color: rgba(201,168,76,0.25); }
            .metric-val {
                font-family: 'Libre Baskerville', serif;
            ...
            @media (min-width: 640px) { .metric-val { font-size: 3.2rem; } }
            .metric-cell:hover .metric-val { transform: scale(1.08); }
            .metric-lbl {
            ...
            @media (min-width: 640px) { .metric-lbl { letter-spacing: 0.18em; margin-top: 14px; } }
            .metric-cell:hover .metric-lbl { color: rgba(255,255,255,0.8); }
            .metric-cell::before {
            ...
            .metric-cell:hover::before { width: 60%; }
            ...
            @media (min-width: 900px) { .features-grid { grid-template-columns: repeat(3, 1fr); gap: 28px; } }

            .feature-card {
                background: #fff;
                border: 1.5px solid var(--border);
                border-radius: 20px; padding: 28px 24px;
                transition: transform 0.3s cubic-bezier(0.34, 1.56, 0.64, 1), box-shadow 0.3s ease, border-color 0.28s;
                position: relative; overflow: hidden;
                box-shadow: 0 4px 16px rgba(45,129,118,0.06);
            }
            @media (min-width: 640px) { .feature-card { padding: 36px 32px; } }
            .feature-card::before {
            ...
            .feature-card::after {
                content: ''; position: absolute; inset: 0;
                background: radial-gradient(circle at top right, rgba(201,168,76,0.04), transparent 80%);
                opacity: 0; transition: opacity 0.3s ease;
            }
            .feature-card:hover { transform: translateY(-8px); box-shadow: 0 24px 56px rgba(45,129,118,0.14); border-color: rgba(45,129,118,0.3); }
            .feature-card:hover::before { transform: scaleX(1); }
            .feature-card:hover::after { opacity: 1; }
            .feature-icon {
                width: 52px; height: 52px; border-radius: 14px;
                background: linear-gradient(135deg, var(--teal-lt), rgba(45,129,118,0.08));
            ...
            .feature-card:hover .feature-icon { transform: rotate(-8deg) scale(1.12); box-shadow: 0 8px 20px rgba(45,129,118,0.18); border-color: var(--teal); }
            .feature-title { font-family: 'Libre Baskerville', serif; font-size: 1.08rem; font-weight: 700; color: var(--ink); margin-bottom: 10px; transition: color 0.25s; }
            .feature-card:hover .feature-title { color: var(--teal); }
            .feature-desc { font-size: 0.86rem; color: var(--ink-soft); line-height: 1.7; }

            /* ── Process ── */
            .process-section {
                background: linear-gradient(180deg, var(--parchment) 0%, rgba(243,236,224,0.5) 100%);
            ...
            @media (min-width: 640px) { .process-step { padding: 40px 28px; } }
            .process-step::before {
                content: ''; position: absolute; top: 0; left: 0; right: 0;
                height: 4px; background: linear-gradient(90deg, var(--teal), var(--gold));
                border-radius: 16px 16px 0 0; opacity: 0; transition: opacity 0.3s;
            }
            .process-step:hover { transform: translateY(-6px); box-shadow: 0 16px 40px rgba(45,129,118,0.12); border-color: rgba(45,129,118,0.3); }
            .process-step:hover::before { opacity: 1; }
            .process-step-head { display: flex; align-items: center; gap: 14px; margin-bottom: 16px; }
            .process-num-wrap {
                width: 48px; height: 48px; border-radius: 50%;
                background: linear-gradient(135deg, var(--teal-lt), rgba(45,129,118,0.12));
                border: 2px solid var(--teal);
                display: flex; align-items: center; justify-content: center;
                flex-shrink: 0; transition: all 0.32s ease;
                box-shadow: 0 6px 16px rgba(45,129,118,0.12);
            }
            .process-step:hover .process-num-wrap { transform: scale(1.15) rotate(6deg); box-shadow: 0 12px 28px rgba(45,129,118,0.2); background: linear-gradient(135deg, var(--teal), var(--teal-lt)); border-color: var(--gold); }
            .process-num { font-family: 'Libre Baskerville', serif; font-size: 0.9rem; font-weight: 700; color: var(--teal); transition: color 0.25s; }
            .process-step:hover .process-num { color: #fff; }
            .process-title { font-family: 'Libre Baskerville', serif; font-size: 1.1rem; font-weight: 700; color: var(--ink); transition: color 0.25s; }
            .process-step:hover .process-title { color: var(--teal); }
            .process-days {
                display: inline-block; font-size: 0.65rem; font-weight: 800;
                letter-spacing: 0.12em; text-transform: uppercase; color: var(--teal);
                background: linear-gradient(135deg, rgba(45,129,118,0.1), rgba(201,168,76,0.08));
                border: 1.5px solid rgba(45,129,118,0.2);
                padding: 5px 12px; border-radius: 24px; margin-bottom: 10px;
                transition: all 0.25s;
            }
            .process-step:hover .process-days { background: var(--teal-lt); border-color: var(--teal); }
            .process-desc { font-size: 0.84rem; color: var(--ink-soft); line-height: 1.7; }
            ...
            @media (min-width: 900px) { .activity-wrapper { grid-template-columns: 1fr 420px; gap: 64px; } }

            .activity-feed-wrap {
                background: linear-gradient(180deg, #fff 0%, var(--cream) 100%);
                border: 1.5px solid var(--border); border-radius: 20px;
                overflow: hidden; box-shadow: 0 8px 24px rgba(45,129,118,0.08);
                order: -1;
            }
            @media (min-width: 900px) { .activity-feed-wrap { order: 0; } }

            .activity-feed-head {
                padding: 18px 22px;
                background: linear-gradient(90deg, var(--parchment) 0%, rgba(232,244,242,0.6) 100%);
                border-bottom: 1.5px solid var(--border);
                display: flex; align-items: center; gap: 12px;
            }
            .live-dot {
                width: 8px; height: 8px; border-radius: 50%;
                background: var(--teal); animation: live-pulse 2s infinite;
            }
            @keyframes live-pulse {
                0%, 100% { box-shadow: 0 0 0 0 rgba(45,129,118,0.5); }
                50%       { box-shadow: 0 0 0 7px rgba(45,129,118,0); }
            }
            .activity-feed-body { height: 300px; overflow: hidden; position: relative; }
            @media (min-width: 640px) { .activity-feed-body { height: 340px; } }
            ...
            @media (min-width: 640px) { .activity-item { padding: 16px 26px; gap: 16px; } }
            .activity-item:hover { background: linear-gradient(90deg, rgba(45,129,118,0.03), transparent); padding-left: 26px; }
            .activity-item::before {
                content: ''; position: absolute; left: 0; top: 0; bottom: 0;
                width: 3px; background: var(--teal); opacity: 0; transition: opacity 0.2s;
            }
            ...
            .activity-icon {
                ...
                transition: all 0.25s; box-shadow: 0 3px 10px rgba(45,129,118,0.08);
            }
            @media (min-width: 640px) { .activity-icon { width: 42px; height: 42px; font-size: 1.1rem; } }
            .activity-item:hover .activity-icon { transform: scale(1.12) rotate(-6deg); }
            .activity-title { font-size: 0.85rem; font-weight: 700; color: var(--ink); }
            .activity-desc  { font-size: 0.78rem; color: var(--ink-soft); line-height: 1.6; margin-top: 2px; }
            .activity-time  { font-size: 0.68rem; color: var(--border-dk); margin-top: 5px; font-weight: 600; }
            ...
            @media (min-width: 900px) { .board-grid { grid-template-columns: repeat(4, 1fr); gap: 18px; } }
            ...
            .board-card:hover { transform: translateY(-8px); box-shadow: 0 20px 48px rgba(45,129,118,0.16); border-color: rgba(45,129,118,0.35); }
            .board-card-top {
                height: 90px;
                background: linear-gradient(135deg, var(--teal-lt) 0%, rgba(201,168,76,0.12) 100%);
                display: flex; align-items: center; justify-content: center;
                position: relative; border-bottom: 2px solid rgba(45,129,118,0.1);
            }
            @media (min-width: 640px) { .board-card-top { height: 120px; } }
            .board-card-top::before {
                content: ''; position: absolute; inset: 0;
                background: radial-gradient(circle at 20% 80%, rgba(201,168,76,0.15), transparent 50%);
            }
            .board-avatar {
            ...
            @media (min-width: 640px) { .board-avatar { width: 68px; height: 68px; font-size: 1.2rem; border-width: 4px; } }
            .board-card:hover .board-avatar { transform: scale(1.12) translateY(-4px); }
            .board-card-body { padding: 14px 14px 18px; }
            @media (min-width: 640px) { .board-card-body { padding: 16px 18px 20px; } }
            .board-name { font-family: 'Libre Baskerville', serif; font-size: 0.88rem; font-weight: 700; color: var(--ink); margin-bottom: 5px; transition: color 0.25s; }
            @media (min-width: 640px) { .board-name { font-size: 0.98rem; } }
            .board-card:hover .board-name { color: var(--teal); }
            .board-role { font-size: 0.62rem; font-weight: 800; letter-spacing: 0.1em; text-transform: uppercase; color: var(--teal); margin-bottom: 6px; transition: color 0.25s; }
            .board-card:hover .board-role { color: var(--gold); }
            .board-expertise { font-size: 0.78rem; color: var(--ink-soft); line-height: 1.6; }
            ...
            @media (min-width: 480px) { .fields-grid { gap: 12px; } }
            @media (min-width: 640px) { .fields-grid { grid-template-columns: repeat(3, 1fr); } }
            @media (min-width: 860px)  { .fields-grid { grid-template-columns: repeat(4, 1fr); gap: 14px; } }
            @media (min-width: 1100px) { .fields-grid { grid-template-columns: repeat(5, 1fr); } }
            ...
            @media (min-width: 640px) { .field-card { padding: 26px 22px 24px; border-radius: 20px; } }
            .field-card::before {
                content: ''; position: absolute; top: 0; left: 0; right: 0;
                height: 4px; background: var(--field-color, var(--teal));
                border-radius: 16px 16px 0 0; transition: height 0.36s; z-index: 2;
            }
            .field-card::after {
                content: ''; position: absolute; inset: 0;
                background: radial-gradient(circle at top right, var(--field-bg, rgba(45,129,118,0.04)), transparent 65%);
                opacity: 0; transition: opacity 0.28s; border-radius: 16px; z-index: 0;
            }
            .field-card:hover::after { opacity: 1; }
            .field-card:hover::before { height: 6px; }
            .field-card:hover { transform: translateY(-6px) scale(1.02); box-shadow: 0 20px 48px rgba(45,129,118,0.12); border-color: var(--field-color, var(--teal)); }
            .field-card > * { position: relative; z-index: 1; }

            .field-icon {
                width: 44px; height: 44px; border-radius: 12px;
                background: var(--field-icon-bg, var(--teal-lt));
                border: 2px solid var(--field-icon-border, rgba(45,129,118,0.2));
                display: flex; align-items: center; justify-content: center;
                margin-bottom: 14px; color: var(--field-color, var(--teal));
                transition: all 0.36s cubic-bezier(0.34, 1.56, 0.64, 1);
                flex-shrink: 0; font-size: 1.2rem;
                box-shadow: 0 5px 14px var(--field-shadow, rgba(45,129,118,0.1));
            }
            @media (min-width: 640px) { .field-icon { width: 52px; height: 52px; font-size: 1.4rem; margin-bottom: 18px; } }
            .field-card:hover .field-icon { background: var(--field-color, var(--teal)); border-color: var(--field-color, var(--teal)); color: #fff; transform: rotate(-10deg) scale(1.2); }

            .field-name {
                font-family: 'Libre Baskerville', serif;
                font-size: 0.8rem; font-weight: 700; color: var(--ink);
                line-height: 1.4; margin-bottom: 8px;
                transition: color 0.25s; letter-spacing: 0.1px;
            }
            @media (min-width: 640px) { .field-name { font-size: 0.88rem; } }
            .field-card:hover .field-name { color: var(--field-color, var(--teal)); }

            .field-count {
                font-size: 0.64rem; font-weight: 700; color: var(--ink-soft);
                letter-spacing: 0.06em; display: flex; align-items: center; gap: 6px;
                margin-top: auto; text-transform: uppercase;
            }
            .field-count::before { content: ''; width: 14px; height: 2px; background: var(--field-color, var(--teal)); opacity: 0.6; border-radius: 2px; }

            /* Field color themes */
            .field-c1  { --field-color:#2d8176;  --field-bg:rgba(45,129,118,0.05);  --field-icon-bg:#e8f4f2;  --field-icon-border:rgba(45,129,118,0.18);  --field-shadow:rgba(45,129,118,0.2); }
            .field-c2  { --field-color:#7c3aed;  --field-bg:rgba(124,58,237,0.05);  --field-icon-bg:#f3eeff;  --field-icon-border:rgba(124,58,237,0.15);  --field-shadow:rgba(124,58,237,0.2); }
            .field-c3  { --field-color:#b45309;  --field-bg:rgba(180,83,9,0.05);    --field-icon-bg:#fff4e0;  --field-icon-border:rgba(180,83,9,0.15);    --field-shadow:rgba(180,83,9,0.2); }
            .field-c4  { --field-color:#0e7490;  --field-bg:rgba(14,116,144,0.05);  --field-icon-bg:#e0f6fc;  --field-icon-border:rgba(14,116,144,0.16);  --field-shadow:rgba(14,116,144,0.2); }
            .field-c5  { --field-color:#c9a84c;  --field-bg:rgba(201,168,76,0.06);  --field-icon-bg:#fdf6e3;  --field-icon-border:rgba(201,168,76,0.2);   --field-shadow:rgba(201,168,76,0.22); }
            .field-c6  { --field-color:#be185d;  --field-bg:rgba(190,24,93,0.05);   --field-icon-bg:#fce7f3;  --field-icon-border:rgba(190,24,93,0.14);   --field-shadow:rgba(190,24,93,0.2); }
            .field-c7  { --field-color:#166534;  --field-bg:rgba(22,101,52,0.05);   --field-icon-bg:#dcfce7;  --field-icon-border:rgba(22,101,52,0.15);   --field-shadow:rgba(22,101,52,0.18); }
            .field-c8  { --field-color:#1d4ed8;  --field-bg:rgba(29,78,216,0.05);   --field-icon-bg:#e0eaff;  --field-icon-border:rgba(29,78,216,0.14);   --field-shadow:rgba(29,78,216,0.2); }
            .field-c9  { --field-color:#9d174d;  --field-bg:rgba(157,23,77,0.05);   --field-icon-bg:#fdf2f8;  --field-icon-border:rgba(157,23,77,0.14);   --field-shadow:rgba(157,23,77,0.2); }
            .field-c10 { --field-color:#0f766e;  --field-bg:rgba(15,118,110,0.05);  --field-icon-bg:#ccfbf1;  --field-icon-border:rgba(15,118,110,0.15);  --field-shadow:rgba(15,118,110,0.2); }
            ...
            @media (min-width: 640px) { .trust-label { margin-bottom: 32px; } }
            .trust-items {
                display: flex; align-items: center;
                justify-content: center;
                gap: 20px; flex-wrap: wrap;
            }
            @media (min-width: 640px) { .trust-items { gap: 32px; } }
            @media (min-width: 900px) { .trust-items { gap: 48px; } }
            .trust-item {
            ...
            @media (min-width: 640px) { .trust-item { font-size: 0.8rem; letter-spacing: 0.08em; gap: 12px; } }
            .trust-item:hover { color: var(--gold); transform: translateY(-2px); }
            .trust-check {
                width: 22px; height: 22px; border-radius: 50%;
                background: rgba(201,168,76,0.2);
                border: 1.5px solid rgba(201,168,76,0.4);
                display: flex; align-items: center; justify-content: center;
                color: var(--gold); flex-shrink: 0; font-size: 0.82rem;
                transition: all 0.25s;
            }
            .trust-item:hover .trust-check { background: rgba(201,168,76,0.4); border-color: var(--gold); transform: scale(1.15); }
            .trust-divider { display: none; }
            @media (min-width: 900px) { .trust-divider { display: block; width: 1px; height: 18px; background: rgba(255,255,255,0.12); } }
            ...
            @media (min-width: 640px) { footer { padding: 64px 32px 40px; } }
            ...
            @media (min-width: 480px) { .footer-inner { grid-template-columns: repeat(2, 1fr); gap: 28px; } }
            @media (min-width: 860px) { .footer-inner { grid-template-columns: 1.4fr 1fr 1fr 1fr; gap: 48px; } }

            .footer-brand { grid-column: 1 / -1; }
            @media (min-width: 860px) { .footer-brand { grid-column: auto; } }

            .footer-brand-name { font-family: 'Libre Baskerville', serif; font-size: 1.05rem; font-weight: 700; color: #fff; margin-bottom: 4px; }
            .footer-brand-sub  { font-size: 0.6rem; font-weight: 700; letter-spacing: 0.14em; text-transform: uppercase; color: var(--gold); }
            .footer-brand-desc { font-size: 0.82rem; line-height: 1.65; margin-top: 12px; }
            .footer-col-title  { font-size: 0.65rem; font-weight: 700; letter-spacing: 0.18em; text-transform: uppercase; color: rgba(255,255,255,0.6); margin-bottom: 14px; }
            ...
            .footer-copy    { font-size: 0.7rem; color: rgba(255,255,255,0.25); letter-spacing: 0.02em; }
            .footer-tagline { font-size: 0.6rem; font-weight: 700; letter-spacing: 0.16em; text-transform: uppercase; color: rgba(255,255,255,0.18); }
            ...
            #scroll-top {
                ...
                z-index: 40; opacity: 0; transform: translateY(16px);
                transition: opacity 0.3s, transform 0.3s, background 0.15s;
            }
            @media (min-width: 640px) { #scroll-top { width: 48px; height: 48px; bottom: 32px; right: 32px; } }
    ...
    <body>
        ...
        <nav class="navbar">
            <div class="nav-inner">
                <a href="/" class="nav-logo">
                    <div class="nav-logo-icon">
                        <svg width="20" height="20" fill="none" stroke="#f0d678" stroke-width="2" viewBox="0 0 24 24">
                            <path d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"/>
                        </svg>
                    </div>
                    <div class="nav-logo-text">
                        <span class="nav-logo-name">Journal System</span>
                        <span class="nav-logo-sub">Academic Publishing Portal</span>
                    </div>
                </a>
            ...
            <div class="mobile-menu" id="mobile-menu">
                <div class="mobile-menu-inner">
                    <a href="/published-papers" class="mobile-nav-link">📄 Published Papers</a>
                    <a href="#fields"            class="mobile-nav-link">🔬 Research Fields</a>
                    <a href="#process"           class="mobile-nav-link">⚙️ Review Process</a>
                    <a href="/login"             class="mobile-nav-link">🔑 Sign In</a>
                    <a href="/register"          class="mobile-nav-register">Register — Submit Now →</a>
                </div>
            </div>
        </nav>
                    ...
                    <div class="index-marquee">
                        ...
                        @foreach ($indexItems as $item)
                            <span class="index-chip">
                                <span class="index-chip-dot"></span>{{ $item }}
                            </span>
                        @endforeach
                    </div>
                </div>
                ...
                <div class="metrics-grid">
                    ...
                    <div class="metric-cell">
                        <div class="metric-val">
                            <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="var(--gold)" stroke-width="2">
                    ...
                    @foreach ($features as $i => $f)
                        <div class="feature-card fade-up fade-up-{{ ($i % 3) + 1 }}">
                            <div class="feature-icon">
                                <svg width="22" height="22" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">{!! $f['icon'] !!}</svg>
                            </div>
                    ...
                    @foreach ($steps as $s)
                        <div class="process-step fade-up">
                            <div class="process-step-head">
                                <div class="process-num-wrap"><span class="process-num">{{ $s['num'] }}</span></div>
                ...
                <div class="activity-wrapper">
                    <div>
                        ...
                        <div style="display:flex;flex-direction:column;gap:12px" class="fade-up fade-up-2">
                            <div style="background:var(--teal-dk);border-radius:14px;padding:22px 22px 20px;border:1px solid rgba(201,168,76,0.15)">
                                <p style="font-size:0.62rem;font-weight:800;letter-spacing:0.2em;text-transform:uppercase;color:var(--gold);margin-bottom:8px">For Authors</p>
                                <p style="font-family:'Libre Baskerville',serif;font-size:1rem;font-weight:700;color:#fff;margin-bottom:6px">Ready to submit your research?</p>
                                <p style="font-size:0.82rem;color:rgba(255,255,255,0.55);margin-bottom:16px;line-height:1.6">Join hundreds of researchers publishing their work through our platform.</p>
                                <a href="/register" style="display:inline-flex;align-items:center;gap:8px;padding:10px 20px;background:var(--gold);color:var(--ink);font-size:0.74rem;font-weight:700;letter-spacing:0.1em;text-transform:uppercase;border-radius:7px;text-decoration:none">
                                    Begin Submission →
                                </a>
                            </div>
                            <div style="background:var(--parchment);border-radius:14px;padding:22px 22px 20px;border:1px solid var(--border-dk)">
                                <p style="font-size:0.62rem;font-weight:800;letter-spacing:0.2em;text-transform:uppercase;color:var(--teal);margin-bottom:8px">For Reviewers</p>
                                <p style="font-family:'Libre Baskerville',serif;font-size:1rem;font-weight:700;color:var(--ink);margin-bottom:6px">Become a peer reviewer</p>
                                <p style="font-size:0.82rem;color:var(--ink-soft);margin-bottom:16px;line-height:1.6">Contribute to scholarly excellence and build your academic reputation.</p>
                                <a href="/register" style="display:inline-flex;align-items:center;gap:8px;padding:10px 20px;background:var(--teal);color:#fff;font-size:0.74rem;font-weight:700;letter-spacing:0.1em;text-transform:uppercase;border-radius:7px;text-decoration:none;box-shadow:0 4px 14px rgba(45,129,118,0.25)">
                                    Join as Reviewer →
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="activity-feed-wrap fade-up fade-up-3">
                        <div class="activity-feed-head">
                            ...
                            <span style="margin-left:auto;font-size:0.68rem;color:var(--border-dk);font-weight:600">{{ $liveActivities->count() }} recent events</span>
                        </div>
                                ...
                                @forelse ($liveActivities as $i => $activity)
                                    <div class="activity-item">
                                        ...
                                        <div>
                                            ...
                                            <div class="activity-time">{{ $activity['timestamp'] ? $activity['timestamp']->diffForHumans() : 'recently' }} · {{ $activity['category'] }}</div>
                                        </div>
                                    </div>
                                @empty
                                    <div class="activity-item">
                    ...
                    @empty
                        @foreach ([['name'=>'Dr. Rafael Santos','role'=>'Editor in Chief','expertise'=>'Computer Science'],['name'=>'Dr. Maria Reyes','role'=>'Managing Editor','expertise'=>'Information Technology'],['name'=>'Prof. Jose Lim','role'=>'Senior Editor','expertise'=>'Electrical Engineering'],['name'=>'Dr. Ana Cruz','role'=>'Associate Editor','expertise'=>'Data Science & AI']] as $i => $m)
                            <div class="board-card fade-up fade-up-{{ $i + 1 }}">
                                <div class="board-card-top"><div class="board-avatar">{{ boardInitials($m['name']) }}</div></div>
                                <div class="board-card-body">
                    ...
                    @forelse ($researchFields as $idx => $field)
                        <div class="field-card {{ $colorClasses[$idx % count($colorClasses)] }} fade-up">
                            <div class="field-icon">
                                <svg width="20" height="20" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">{!! getFieldIcon($field['name'], $fieldIconMap) !!}</svg>
                            </div>
                            <div class="field-name">{{ $field['name'] }}</div>
                            @if (!empty($field['count']) && $field['count'] > 0)
                                <div class="field-count">{{ $field['count'] }} {{ $field['count'] == 1 ? 'paper' : 'papers' }}</div>
                            @endif
                        </div>
                    @empty
                        @foreach (['Artificial Intelligence','Software Engineering','Cybersecurity','Renewable Energy','Data Science','Biotechnology','Networking','Cloud Computing','IoT Systems','Innovation'] as $idx => $name)
                            <div class="field-card {{ $colorClasses[$idx % count($colorClasses)] }} fade-up">
                                <div class="field-icon">
                                    <svg width="20" height="20" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">{!! getFieldIcon($name, $fieldIconMap) !!}</svg>
                                </div>
        ...
        <footer>
            <div class="footer-inner">
                <div class="footer-brand">
                    ...
                    <p class="footer-brand-desc">
                        The official peer-reviewed international journal committed to advancing
            ...
            <div class="footer-bottom">
                <span class="footer-copy">© {{ date('Y') }} Journal System — All rights reserved.</span>
