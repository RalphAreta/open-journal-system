    ...
    <head>
        ...
        <style>
            ...
            *::after {
            ...
            .cta-card-author .cta-title {
                color: #fff;
            }
            .cta-card-reviewer .cta-title {
                color: var(--ink);
            }
            .cta-desc {
                font-size: 0.88rem;
            ...
            .cta-card-author .cta-desc {
                color: rgba(255, 255, 255, 0.6);
            }
            .cta-card-reviewer .cta-desc {
                color: var(--ink-soft);
            }
            .cta-list {
                list-style: none;
            ...
            .cta-card-author .cta-list li {
                color: rgba(255, 255, 255, 0.75);
            }
            .cta-card-reviewer .cta-list li {
                color: var(--ink-soft);
            }
            .cta-check {
                width: 18px;
                ...
                <a href="/" class="nav-logo">
                    ...
                    <div class="nav-logo-text">
                        ...
                        <span class="nav-logo-sub">
                            Academic Publishing Portal Research Journal
                        </span>
                    </div>
                </a>
        ...
        <footer>
            <div class="footer-inner">
                <div>
                    ...
                    <p class="footer-brand-desc">
                        The official peer-reviewed international journal of our
                        institution, committed to advancing knowledge in
            ...
            <div class="footer-bottom">
                <span class="footer-copy">
                    © {{ date('Y') }} Journal System — Academic Publishing
                    Portal International Research Journal. All rights reserved.
                </span>
