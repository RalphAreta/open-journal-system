...
<head>
    ...
    <title>Journal System | Academic Publishing Portal International Research Journal</title>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .btn-nav-register {
            ...
            border-radius: 8px;
            text-decoration: none;
            box-shadow: 0 4px 14px rgba(45,129,118,.28);
            transition: background .15s, transform .12s, box-shadow .15s;
        }
        .btn-nav-register:hover {
            background: var(--teal-dk);
            transform: translateY(-1px);
            box-shadow: 0 8px 20px rgba(45,129,118,.32);
        }
        ...
        .metric-cell:hover { background: rgba(255,255,255,.04); }
        .metric-val {
            font-family: 'Libre Baskerville', serif;
            font-size: 2.6rem;
            font-weight: 700;
        ...
        .feature-card:hover {
            ...
            box-shadow: 0 16px 40px rgba(45,129,118,.1);
            border-color: rgba(45,129,118,.2);
        }
        ...
        .process-step:hover .process-num-wrap {
            ...
            box-shadow: 0 0 0 5px rgba(45,129,118,.08);
        }
        .process-num {
            font-family: 'Libre Baskerville', serif;
            font-size: .78rem;
        ...
        .process-days {
            ...
            color: var(--teal);
            background: var(--teal-lt);
            border: 1px solid rgba(45,129,118,.18);
            padding: 3px 10px;
            border-radius: 20px;
            margin-bottom: 10px;
        }
        ...
        .cta-card-author .cta-badge {
            background: rgba(201,168,76,.2);
            color: var(--gold);
            border: 1px solid rgba(201,168,76,.3);
        }
        .cta-card-reviewer .cta-badge {
            background: var(--teal-lt);
            color: var(--teal-dk);
            border: 1px solid rgba(45,129,118,.2);
        }
        .cta-title {
            font-family: 'Libre Baskerville', serif;
            font-size: 1.7rem;
        ...
        .cta-card-author .cta-title { color: #fff; }
        .cta-card-reviewer .cta-title { color: var(--ink); }
        .cta-desc {
            font-size: .88rem;
            line-height: 1.65;
            margin-bottom: 28px;
        }
        .cta-card-author .cta-desc { color: rgba(255,255,255,.6); }
        .cta-card-reviewer .cta-desc { color: var(--ink-soft); }
        .cta-list {
            list-style: none;
        ...
        .cta-card-author .cta-list li { color: rgba(255,255,255,.75); }
        .cta-card-reviewer .cta-list li { color: var(--ink-soft); }
        .cta-check {
        ...
        .cta-card-author .cta-check {
            background: rgba(201,168,76,.2);
            color: var(--gold);
        }
        .cta-card-reviewer .cta-check {
            background: var(--teal-lt);
            color: var(--teal);
        }
        .btn-cta-author {
        ...
        .btn-cta-author:hover { background: #d9b85c; transform: translateY(-1px); }
        .btn-cta-reviewer {
            display: inline-flex;
            align-items: center;
            gap: 8px;
        ...
        .btn-cta-reviewer:hover { background: var(--teal-dk); transform: translateY(-1px); }
        ...
        .board-card:hover {
            transform: translateY(-4px);
            box-shadow: 0 14px 36px rgba(45,129,118,.1);
            border-color: rgba(45,129,118,.2);
        }
        .board-card-top {
            height: 110px;
            background: linear-gradient(135deg, var(--teal-lt), rgba(201,168,76,.08));
            display: flex;
            align-items: center;
            justify-content: center;
            position: relative;
        ...
        .field-card::after {
            ...
            position: absolute;
            inset: 0;
            background: linear-gradient(135deg, rgba(45,129,118,.06), rgba(201,168,76,.04));
            opacity: 0;
            transition: opacity .2s;
        }
        .field-card:hover {
            border-color: rgba(45,129,118,.25);
            transform: translateY(-2px);
            box-shadow: 0 8px 24px rgba(45,129,118,.08);
        }
        ...
        .field-icon {
            ...
            border-radius: 10px;
            background: var(--teal-lt);
            border: 1px solid rgba(45,129,118,.14);
            display: flex;
            align-items: center;
            justify-content: center;
            margin-bottom: 14px;
        ...
        #scroll-top {
            ...
            align-items: center;
            justify-content: center;
            box-shadow: 0 6px 20px rgba(45,129,118,.35);
            z-index: 40;
            opacity: 0;
        ...
        .fade-up-1 { transition-delay: .08s; }
        .fade-up-2 { transition-delay: .16s; }
        .fade-up-3 { transition-delay: .24s; }
        .fade-up-4 { transition-delay: .32s; }
    </style>
</head>
<body>
    ...
    <div class="hero-inner">
        <div>
            ...
            <p class="hero-p">
                ...
                high-impact research in engineering, science, information technology, and innovation.
            </p>
            <div class="hero-cta">
    ...
    <div class="index-bar-inner">
        ...
        <div class="index-marquee-wrap">
            <div class="index-marquee">
                @php
                    $indexItems = ['Google Scholar','DOAJ','ROAD','ISSN Portal','Crossref','Dimensions','Semantic Scholar','BASE','EuroPub','WorldCat','Google Scholar','DOAJ','ROAD','ISSN Portal','Crossref','Dimensions','Semantic Scholar','BASE','EuroPub','WorldCat'];
                @endphp
        ...
        <div class="activity-wrapper">
            ...
            <div>
                <div class="fade-up" style="margin-bottom:48px;">
                    ...
                    <h2 class="section-title" style="text-align:left;margin-bottom:10px;">Research Activity <em>In Progress</em></h2>
                    <p class="section-sub" style="text-align:left;">Real-time updates from our scholarly community — submissions, reviews, and publications happening now.</p>
                </div>

                {{-- CTA Cards ── --}}
                <div style="display:flex;flex-direction:column;gap:14px;" class="fade-up fade-up-2">
                    <div style="background:var(--teal-dk);border-radius:14px;padding:28px 28px 24px;border:1px solid rgba(201,168,76,.15);">
                        <p style="font-size:.62rem;font-weight:800;letter-spacing:.2em;text-transform:uppercase;color:var(--gold);margin-bottom:10px;">For Authors</p>
                        ...
                        <p style="font-size:.82rem;color:rgba(255,255,255,.55);margin-bottom:18px;line-height:1.6;">Join hundreds of researchers publishing their work through our platform.</p>
                        <a href="/register" class="btn-cta-author" style="display:inline-flex;align-items:center;gap:8px;padding:10px 22px;background:var(--gold);color:var(--ink);font-size:.74rem;font-weight:700;letter-spacing:.1em;text-transform:uppercase;border-radius:7px;text-decoration:none;">
                            Begin Submission →
                        </a>
                    </div>
                    <div style="background:var(--parchment);border-radius:14px;padding:28px 28px 24px;border:1px solid var(--border-dk);">
                        <p style="font-size:.62rem;font-weight:800;letter-spacing:.2em;text-transform:uppercase;color:var(--teal);margin-bottom:10px;">For Reviewers</p>
                        ...
                        <p style="font-size:.82rem;color:var(--ink-soft);margin-bottom:18px;line-height:1.6;">Contribute to scholarly excellence and build your academic reputation.</p>
                        <a href="/register" class="btn-cta-reviewer" style="display:inline-flex;align-items:center;gap:8px;padding:10px 22px;background:var(--teal);color:#fff;font-size:.74rem;font-weight:700;letter-spacing:.1em;text-transform:uppercase;border-radius:7px;text-decoration:none;box-shadow:0 4px 14px rgba(45,129,118,.25);">
                            Join as Reviewer →
                        </a>
                    </div>
                </div>
            ...
            <div class="activity-feed-wrap fade-up fade-up-3">
                <div class="activity-feed-head">
                    ...
                    <span style="font-size:.65rem;font-weight:800;letter-spacing:.16em;text-transform:uppercase;color:var(--teal);">Live Feed</span>
                    <span style="margin-left:auto;font-size:.68rem;color:var(--border-dk);font-weight:600;">{{ $liveActivities->count() }} recent events</span>
                </div>
...
<section class="section board-section">
    <div class="section-inner">
        ...
        @php
            // Extract initials: strip titles (Dr., Prof., Mr., Ms., etc.) then take first letter of first & last word
        ...
        <div class="fields-grid">
            @php
                ...
                $fieldIconMap = [
                    ...
                    // Humanities
                    'humanit'     => '<path stroke-linecap="round" stroke-linejoin="round" d="M12 6.042A8.967 8.967 0 006 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 016 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 016-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0018 18a8.967 8.967 0 00-6 2.292m0-14.25v14.25"/>',
                    'arts'        => '<path stroke-linecap="round" stroke-linejoin="round" d="M12 6.042A8.967 8.967 0 006 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 016 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 016-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0018 18a8.967 8.967 0 00-6 2.292m0-14.25v14.25"/>',
                    // Data / Analytics
                    ...
                    // Default fallback
                    'default'     => '<path stroke-linecap="round" stroke-linejoin="round" d="M12 6.042A8.967 8.967 0 006 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 016 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 016-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0018 18a8.967 8.967 0 00-6 2.292m0-14.25v14.25"/>',
                ];

                // Match field name to icon by keyword
            ...
            @endphp
            @forelse($researchFields as $field)
                <div class="field-card fade-up">
                    <div class="field-icon">
                        <svg width="18" height="18" fill="none" stroke="currentColor" stroke-width="1.7" viewBox="0 0 24 24">
            ...
            @empty
                @foreach([
                    ...
                    'Renewable Energy','Data Science','Biotechnology',
                    'Networking','Cloud Computing','IoT Systems','Innovation',
                ] as $name)
                    <div class="field-card fade-up">
                        <div class="field-icon">
                            <svg width="18" height="18" fill="none" stroke="currentColor" stroke-width="1.7" viewBox="0 0 24 24">
...
<footer>
    <div class="footer-inner">
        <div>
            ...
            <p class="footer-brand-desc">
                The official peer-reviewed international journal of our institution,
                committed to advancing knowledge in engineering, science, and technology.
            </p>
        </div>
        <div>
    ...
    <div class="footer-bottom">
        <span class="footer-copy">© {{ date('Y') }} Journal System — Academic Publishing Portal International Research Journal. All rights reserved.</span>
