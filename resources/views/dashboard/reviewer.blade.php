        ...
        function declineInvitation(event, assignmentId, title) {
            ...
            if (typeof Swal !== 'undefined') {
                Swal.fire({
                    ...
                    html: `Are you sure you want to decline the review for<br><strong>${title}</strong>?<br><br><textarea id="decline-reason-input" placeholder="Why are you declining? (Optional)" style="width:100%;height:80px;padding:8px;border:1px solid #e8dfd0;border-radius:6px;font-family:inherit;font-size:14px;color:#3d2f1a;"></textarea>`,
                    icon: 'warning',
