...
@section('content')
    <div class="max-w-7xl mx-auto">
        ...
        >
            {{-- Table Header --}}
            <div
                class="px-4 py-2 bg-[#faf8f5] border-b border-[#ede8e0] grid grid-cols-[16px_1fr_auto] gap-3 items-center"
            >
                <div></div>
                <p
            ...
            @forelse ($notifications as $notif)
                <div
                    class="px-4 py-2.5 border-b border-[#f3efe9] last:border-b-0 grid grid-cols-[16px_1fr_auto] gap-3 items-start {{ is_null($notif->read_at) ? 'bg-[#f0faf8]' : 'bg-white' }} hover:bg-[#faf8f5] transition-colors duration-150"
                >
                    {{-- Dot --}}
                    ...
                    <div class="min-w-0">
                        <p
                            class="text-sm font-semibold text-[#0d1628] leading-snug truncate"
                        >
                            {{ $notif->title }}
                        </p>
                        <p
                            class="text-xs text-[#6a7890] leading-snug mt-0.5 line-clamp-1"
                        >
                            {{ $notif->message }}
                        </p>
                    </div>
