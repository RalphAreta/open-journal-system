...
@push('styles')
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .breadcrumb svg { color: var(--border-dk); }
        ...
        .role-card:hover .accent-line { width: 40px; }
...
<div class="aw aw-bg max-w-7xl mx-auto px-4">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
            <div>
                <nav class="breadcrumb">
                    ...
                    <svg width="10" height="10" fill="none" stroke="currentColor" stroke-width="3" viewBox="0 0 24 24"><path d="M9 5l7 7-7 7"/></svg>
                    <span style="color: var(--ink)">Access Control</span>
                </nav>
                <p class="hero-eyebrow">System Administration</p>
                <h1 class="hero-title">Roles &amp; <em>Permissions</em></h1>
                <p class="hero-sub">Define access levels and configure role-based permissions across the system</p>
            </div>
            <a href="{{ route('dashboard.admin') }}" class="btn-back self-start md:self-auto shrink-0">
                <svg width="12" height="12" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><path d="M15 19l-7-7 7-7" stroke-linecap="round" stroke-linejoin="round"/></svg>
                Back to Dashboard
            </a>
        </div>
    </div>
    ...
    {{-- ── Summary Strip ── --}}
    <div class="summary-strip fu1 mb-10">
        ...
        <div class="summary-item">
            <span class="summary-val serif">{{ $roles->sum(fn($r) => $r->users_count ?? $r->users->count()) }}</span>
            <span class="summary-lbl">Total Users Assigned</span>
        </div>
        <div class="summary-divider"></div>
        <div class="summary-item">
            <span class="summary-val serif" style="color: var(--teal)">OK</span>
            <span class="summary-lbl">Access System Status</span>
        </div>
    </div>
        ...
        <div class="roles-grid">
            ...
            <div class="role-card">
                ...
                <div class="role-watermark">
                    <svg width="88" height="88" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div class="role-card-body">
                    <div>
                        ...
                        <p class="role-name">{{ $role->display_name }}</p>
                    </div>
                    ...
                    <div class="role-footer">
                        <div>
                            ...
                            <p class="role-user-count">{{ sprintf('%02d', $role->users_count ?? $role->users->count()) }}</p>
                        </div>
                        <a href="{{ route('admin.roles.edit', $role) }}" class="btn-configure">
