    ...
    >
        ...
        <div class="relative pt-10 pb-7 mb-9 border-b border-[#e8dfd0] fu">
            ...
            >
                ...
                >
                    <span
                        class="hidden sm:inline-block text-[.7rem] font-semibold tracking-[.06em] uppercase text-[#6b5740] bg-[#f3ece0] border border-[#e8dfd0] px-4 py-[5px] rounded-full"
                    >
                        {{ now()->format('D, M j Y') }}
                    </span>
        ...
        <div class="fu1 mb-6">
            <div class="relative">
                <svg
                    class="absolute left-4 top-1/2 -translate-y-1/2 w-[17px] h-[17px] text-[#6b5740] pointer-events-none"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                >
                ...
                <input
                    ...
                    class="field w-full pl-11 pr-4 py-3 bg-white border border-[#e8dfd0] rounded-lg text-[.95rem] text-[#1a1209] placeholder:text-[#b5a595] transition-all shadow-[0_1px_4px_rgba(26,18,9,.05)]"
                    onkeyup="filterBoard()"
                />
            </div>
        </div>
        ...
        >
            ...
            >
                ...
                <span
                    class="text-[.68rem] font-semibold text-[#6b5740] bg-[#faf6ef] border border-[#e8dfd0] px-3 py-[3px] rounded-full"
                >
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-left" id="boardTable">
                    <thead class="bg-[#f3ece0] border-b border-[#c9b99a]">
                        <tr>
                            <th
                                class="px-6 py-[10px] text-[.6rem] font-bold tracking-[.1em] uppercase text-[#6b5740]"
                            >
                                Manuscript Title
                            </th>
                            <th
                                class="px-6 py-[10px] text-[.6rem] font-bold tracking-[.1em] uppercase text-[#6b5740] w-[170px]"
                            >
                                Status
                            </th>
                            <th
                        ...
                        @forelse ($submissions as $s)
                            ...
                            >
                                ...
                                <td class="px-6 py-[17px]">
                                    ...
                                    <span
                                        class="inline-block mt-1.5 text-[.68rem] font-bold text-[#2d8176] tracking-[.06em] bg-[rgba(45,129,118,.07)] border border-[rgba(45,129,118,.22)] px-2 py-[2px] rounded"
                                    >
                                ...
                                >
                                    ...
                                    >
                                        <a
                                            ...
                                            class="text-[.68rem] font-bold tracking-[.06em] uppercase text-[#6b5740] hover:text-[#2d8176] transition-colors"
                                        >
                                            View
                                        </a>
                                        @if ($s->isEditableByAuthor())
                                            <span
                                                class="text-[#e8dfd0] select-none"
                                            >
                                                |
                                            </span>
                                            <a
                                                href="{{ route('submissions.edit', $s) }}"
                                                class="text-[.68rem] font-bold tracking-[.06em] uppercase text-[#c9a84c] hover:text-[#8a6e28] transition-colors"
                                            >
                                                Edit
                                            </a>
                                        @endif
                        ...
                        @empty
                            <tr>
                                <td colspan="4" class="px-6 py-20 text-center">
                                    ...
                                    <p
                                        class="text-[.82rem] text-[#b5a595] mt-1.5"
                                    >
