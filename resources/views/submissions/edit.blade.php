        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-end gap-5">
            <div>
                ...
                <h1 class="font-['Libre_Baskerville',serif] text-[2.4rem] font-bold
                    ...
                    Refine Your <em class="italic text-[#2d8176]">Submission</em>
                </h1>
                <p class="mt-2 text-[.98rem] text-[#6b5740]">
                    Update manuscript metadata or replace the active research file.
                </p>
            </div>
            ...
            <a href="{{ route('submissions.show', $submission) }}"
               class="inline-flex items-center gap-2 shrink-0
                      ...
                      text-[.76rem] font-bold tracking-[.08em] uppercase text-[#6b5740]
                      shadow-[0_2px_8px_rgba(26,18,9,.06)]
                      hover:text-[#2d8176] hover:border-[#2d8176] hover:bg-[#e8f4f2]
                      transition-all">
                    ...
                    <div>
                        ...
                        <textarea name="title" id="title" rows="3" required
                            class="field w-full px-4 py-3 border rounded-lg
                                   ...
                                   {{ $errors->has('title') ? 'border-red-300 bg-red-50' : 'border-[#e8dfd0]' }}">{{ old('title', $submission->title) }}</textarea>
                        @error('title')
                            ...
                            <div class="relative">
                                <select name="research_field" id="research_field" required
                                    class="field w-full px-4 py-3 pr-10 border rounded-lg
                                           ...
                                           {{ $errors->has('research_field') ? 'border-red-300 bg-red-50' : 'border-[#e8dfd0]' }}">
                    ...
                    <div>
                        ...
                        <textarea name="abstract" id="abstract" rows="7" required
                            class="field w-full px-4 py-3 border rounded-lg
                                   ...
                                   placeholder:text-[#b5a595]
                                   {{ $errors->has('abstract') ? 'border-red-300 bg-red-50' : 'border-[#e8dfd0]' }}">{{ old('abstract', $submission->abstract) }}</textarea>
                        @error('abstract')
                            <p class="mt-1.5 text-[.8rem] text-red-600 font-medium">{{ $message }}</p>
                        @enderror
                    </div>
            ...
            <div class="bg-white border border-[#c9b99a] rounded-[14px] overflow-hidden
                ...
                <div class="px-7 py-7 space-y-4">
                    ...
                    <div class="flex items-center gap-4 px-5 py-4
                                bg-[#e8f4f2] border border-[rgba(45,129,118,.3)] rounded-xl">
                        <div class="w-10 h-10 bg-white rounded-lg flex items-center justify-center
                                    text-[#2d8176] border border-[#e8dfd0] shrink-0
                        ...
                        <div>
                            <p class="text-[.68rem] font-extrabold tracking-[.12em] uppercase
                                      text-[#1a4d46] mb-0.5">
                                Active File
                            </p>
                            <p class="text-[.88rem] font-semibold text-[#2d8176]">
                    ...
                    <div class="dropzone relative cursor-pointer
                        ...
                        <div class="py-10 px-6">
                            ...
                            <p class="text-[.85rem] text-[#6b5740]">
                                Leave blank to keep the current file — PDF, DOC, DOCX, max 10 MB
                            </p>
                    ...
                    @error('file')
                        <p class="text-center text-[.8rem] text-red-600 font-medium">{{ $message }}</p>
                    @enderror
        ...
        <div class="lg:col-span-4 fu1">
            <div class="bg-white border border-[#c9b99a] rounded-[14px] overflow-hidden
                ...
                <div class="px-6 py-5 space-y-3">
                    ...
                    {{-- Current Stage --}}
                    <div class="px-4 py-3 bg-[#faf6ef] border border-[#e8dfd0] rounded-xl">
                        <p class="text-[.65rem] font-extrabold tracking-[.14em] uppercase
                                  text-[#6b5740] mb-1">
                            Current Stage
                        </p>
                        @php
                        ...
                        <span class="inline-flex items-center gap-2 px-3 py-1.5
                                     rounded-full border text-[.7rem] font-bold
                                     tracking-[.06em] uppercase {{ $cls }}">
                            <span class="w-[6px] h-[6px] rounded-full {{ $dot }}"></span>
                            {{ $label }}
                        </span>
                    </div>
                    ...
                    <div class="px-4 py-3 bg-[#faf6ef] border border-[#e8dfd0] rounded-xl">
                        ...
                        <p class="font-['Libre_Baskerville',serif] text-[1.4rem] font-bold
                    ...
                    <div class="px-4 py-3 bg-[#faf6ef] border border-[#e8dfd0] rounded-xl">
                        ...
                        <span class="inline-block font-['Source_Sans_3',sans-serif]
                                     text-[.78rem] font-bold text-[#2d8176] tracking-[.06em]
                                     bg-[rgba(45,129,118,.07)] border border-[rgba(45,129,118,.22)]
                                     px-3 py-1 rounded">
                            #{{ str_pad($submission->id, 5, '0', STR_PAD_LEFT) }}
                        </span>
                    </div>
                    ...
                    {{-- Editor note --}}
                    <div class="px-4 py-4 bg-[#fdf8ec] border border-[rgba(201,168,76,.3)]
                                rounded-xl mt-1">
                        <p class="text-[.65rem] font-extrabold tracking-[.14em] uppercase
                                  text-[#8a6e28] mb-2">
                            Editorial Note
                        </p>
                        <p class="text-[.85rem] italic text-[#6b5740] leading-relaxed">
                            Changes made here will be logged in the manuscript history
                            and visible to the editorial board.
                        </p>
                    </div>
