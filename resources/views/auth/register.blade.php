...
@push('styles')
    ...
    <style>
        ...
        .lp-fade-up {
            opacity: 0;
            animation: fadeUp 0.7s cubic-bezier(0.22, 0.68, 0, 1.2) forwards;
        }
        ...
        .top-accent {
            ...
            animation: line-grow 0.8s cubic-bezier(0.22, 0.68, 0, 1.2) 0.1s both;
        }
        ...
        #expertise-container {
            ...
            opacity: 0;
            transition:
                max-height 0.4s cubic-bezier(0.22, 0.68, 0, 1.2),
                opacity 0.3s ease,
                margin 0.3s ease;
            margin-top: 0;
        }
...
@section('content')
    ...
    >
        {{-- ═══════════════════ LEFT: Brand Panel ═══════════════════ --}}
        <div
            class="brand-panel relative flex-none md:w-[42%] flex flex-col justify-center px-6 py-10 md:p-14 lg:p-20 overflow-hidden"
            style="
        ...
        >
            ...
            {{-- Floating orbs --}}
            <div
                class="orb absolute -top-24 -right-16 w-80 h-80 rounded-full opacity-25 blur-3xl pointer-events-none z-4"
                style="
            ...
            ></div>
            <div
                class="orb-2 absolute -bottom-32 -left-20 w-96 h-96 rounded-full opacity-20 blur-3xl pointer-events-none z-4"
                style="
                    background: radial-gradient(
                        circle at 60% 60%,
                        #1a3a5c,
            ...
            <div class="relative z-10 max-w-sm">
                ...
                {{-- Headline --}}
                <h1
                    class="brand-headline font-playfair text-shadow text-white text-3xl md:text-4xl lg:text-[2.75rem] font-bold leading-[1.2] lp-fade-up mb-3 md:mb-5"
                ...
                <p
                    class="rp-mobile-hide text-shadow text-[.875rem] leading-relaxed text-white/80 lp-fade-up border-l-2 border-[#c9a84c]/50 pl-4 mb-8"
                ...
                <div
                    class="rp-mobile-hide lp-fade-up space-y-3"
                ...
                <div
                    class="rp-mobile-hide lp-fade-up flex gap-5 mt-10 pt-8 border-t border-white/10"
                    style="animation-delay: 0.7s"
                >
                    @foreach ([['100%', 'Peer Reviewed'], ['Free', 'Open Access'], ['Indexed', 'Impact Factor']] as [$v, $l])
                        <div>
                            <div class="text-[#f0d678] font-semibold text-sm">
                                {{ $v }}
                            </div>
                            <div
                                class="text-white/50 text-[.6rem] tracking-widest uppercase mt-0.5"
                            >
                                {{ $l }}
                            </div>
                        </div>
                ...
                <div
                    class="flex md:hidden gap-5 mt-3 pt-3 border-t border-white/10 lp-fade-up"
                    style="animation-delay: 0.5s"
                >
                    @foreach ([['100%', 'Peer Reviewed'], ['Free', 'Open Access'], ['Indexed', 'Impact']] as [$v, $l])
                        <div>
                            <div class="text-[#f0d678] font-semibold text-xs">
                                {{ $v }}
                            </div>
                            <div
                                class="text-white/50 text-[.58rem] tracking-widest uppercase mt-0.5"
                            >
                                {{ $l }}
                            </div>
                        </div>
        ...
        <div
            class="right-panel flex-1 flex items-start md:items-center justify-center p-3 sm:p-6 md:p-10 lg:p-14 relative overflow-x-hidden overflow-y-auto"
            style="
                background: linear-gradient(
                    145deg,
                    #f7f3ec 0%,
        ...
        >
            ...
            {{-- ── Register Card ── --}}
            <div
                class="register-card relative z-10 w-full max-w-2xl bg-white/85 backdrop-blur-2xl border border-[#c9a84c]/18 rounded-2xl shadow-2xl shadow-[#a07830]/12 overflow-hidden my-4 md:my-6"
            >
                ...
                <div class="card-inner-pad p-5 sm:p-8 md:p-10">
                    ...
                    <p
                        class="text-[.78rem] sm:text-[.8rem] text-[#8a96a8] font-light mb-5 md:mb-7"
                    >
                    ...
                    >
                        ...
                        <div id="expertise-container">
                            ...
                            >
                                ...
                                >
                                    Select all areas that match your academic
                                    background.
                                </p>
                                <div
                                    class="expertise-grid grid grid-cols-1 sm:grid-cols-2 gap-0.5 max-h-44 overflow-y-auto pr-1 scroll-thin"
                                >
                    ...
                    {{-- Login link --}}
                    <p
                        class="text-center mt-5 md:mt-6 text-[.8rem] text-[#8a96a8]"
                    >
                        Already have an account?&nbsp;
                        <a
                            href="{{ route('login') }}"
                            class="text-[#a07830] font-semibold border-b border-dashed border-[#a07830]/40 hover:text-[#c9a84c] hover:border-[#c9a84c]/50 transition-colors"
                        >
                            Sign In Instead
                        </a>
                    </p>
    ...
    <script>
        ...
        function togglePassword(fieldId, btn) {
            ...
            open.style.display = isHide ? 'none' : '';
            closed.style.display = isHide ? '' : 'none';
        }
