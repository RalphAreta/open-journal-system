...
<div class="min-h-screen flex flex-col md:flex-row font-body bg-slate-50">
    ...
    <div class="w-full md:w-2/5 flex items-start justify-center bg-white px-8 sm:px-12 py-12 relative overflow-y-auto
        ...
        <div class="w-full max-w-[400px] py-2">
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-5">
                ...
                <div class="fade-in-2">
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" required
                        class="field w-full px-3.5 py-[11px] border rounded-[9px] bg-slate-50 text-sm text-slate-900 transition-all placeholder:text-slate-400
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input id="reg-password" type="password" name="password" required
                                class="field w-full px-3.5 py-[11px] pr-10 border rounded-[9px] bg-slate-50 text-sm text-slate-900 transition-all
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input id="reg-confirm" type="password" name="password_confirmation" required
                                class="field w-full px-3.5 py-[11px] pr-10 border border-slate-200 rounded-[9px] bg-slate-50 text-sm text-slate-900 transition-all"
                                placeholder="••••••••">
