                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input id="reg-password" type="password" name="password" required
                                   class="w-full px-4 py-3.5 rounded-xl border transition-all outline-none pr-10 {{ $errors->has('password') ? 'border-red-500 bg-red-50/30' : 'border-slate-200 bg-slate-50/50 focus:border-red-500' }}">
                            <button type="button" onclick="togglePassword('reg-password', 'eye-reg')" class="absolute inset-y-0 right-3 flex items-center text-slate-400 hover:text-red-600">
                                <svg id="eye-reg" class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" /><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" /></svg>
                            </button>
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="relative">
                            <input id="reg-confirm" type="password" name="password_confirmation" required
                                   class="w-full px-4 py-3.5 rounded-xl border border-slate-200 bg-slate-50/50 focus:border-red-500 outline-none pr-10">
                            <button type="button" onclick="togglePassword('reg-confirm', 'eye-conf')" class="absolute inset-y-0 right-3 flex items-center text-slate-400 hover:text-red-600">
